...
import segment_ultra_nerf as run_nerf_ultrasound
from load_us import load_us_data

basedir = './logs/for_paper/ablation_study/'#'./logs/for_paper/'
expname = 'for_paper_USNeRF_v1_noMod'#for_paper_USNeRF_v1
...
for i, c2w in enumerate(poses):
    ...
    imageio.imwrite(output_dir_output + "Generated_segmentation " + str(1000 + i) + ".png",
                    tf.image.convert_image_dtype(tf.transpose(tf.round(rendering_params['segmentation_map'])), tf.uint8))
